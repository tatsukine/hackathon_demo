...
export default function AwsCognitoDemo() {
  ...
  const handleSendAPI = async () => {
    ...
    try {
      const res = await fetch("https://5jc110act2.execute-api.us-east-1.amazonaws.com/default/helloFunc", {
        method: "GET",
        headers: {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      ...
      <h2 className="text-xl font-semibold mb-2">Send API when Logged in</h2>
      <div className="mb-3">
        <button
          className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded mb-2"
